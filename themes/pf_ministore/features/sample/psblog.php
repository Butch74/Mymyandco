...
/*DATA FOR TABLE psblogcat*/
 ...
 $query_sql['psblogcat'][] = 'INSERT INTO '._DB_PREFIX_.'psblogcat( `id_psblogcat`,`image`,`id_parent`,`item`,`level_depth`,`active`,`show_title`,`position`,`submenu_content`,`privacy`,`position_type`,`menu_class`,`content`,`icon_class`,`level`,`left`,`right`,`date_add`,`date_upd`,`template` ) 
							VALUES(\'4\', \'\', \'3\', \'\', \'2\', \'1\', \'0\', \'0\', \'\', \'0\', \'\', \'\', \'\', \'\', \'0\', \'0\', \'0\', \'2013-11-27 01:07:34\', \'2016-12-07 23:47:42\', \'default\')'; 
 $query_sql['psblogcat'][] = 'INSERT INTO '._DB_PREFIX_.'psblogcat( `id_psblogcat`,`image`,`id_parent`,`item`,`level_depth`,`active`,`show_title`,`position`,`submenu_content`,`privacy`,`position_type`,`menu_class`,`content`,`icon_class`,`level`,`left`,`right`,`date_add`,`date_upd`,`template` ) 
...
/*DATA FOR TABLE psblogcat_lang*/
 ...
 $query_sql['psblogcat_lang'][] = 'INSERT INTO '._DB_PREFIX_.'psblogcat_lang( `id_psblogcat`,`id_lang`,`title`,`content_text`,`description`,`meta_keywords`,`meta_description`,`link_rewrite` ) 
							VALUES(\'4\', \'_LANGUAGEID_\', \'Home design\', \'<p>Odio ut pretium ligula quam Vestibulum consequat convallis fringilla Vestibulum nulla. Accumsan morbi tristique auctor. At risus pretium urna tortor metus fringilla interdum mauris tempor congue</p>\', \'\', \'joomla,prestashop,pstheme,pavothemes\', \'\', \'home-design\')'; 
 $query_sql['psblogcat_lang'][] = 'INSERT INTO '._DB_PREFIX_.'psblogcat_lang( `id_psblogcat`,`id_lang`,`title`,`content_text`,`description`,`meta_keywords`,`meta_description`,`link_rewrite` ) 
...
/*DATA FOR TABLE psblog_blog*/
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'3\', \'4\', \'0\', \'2013-11-28\', \'1\', \'0\', \'40\', \'b-blog-1.jpg\', \'\', \'2013-12-20 09:55:38\', \'<iframe width=\"560\" height=\"315\" src=\"//www.youtube.com/embed/lzY4lkT8ElU\" frameborder=\"0\" allowfullscreen></iframe>\', \'\', \'0\', \'1\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'4\', \'4\', \'2\', \'2013-12-04\', \'1\', \'0\', \'107\', \'b-blog-2.jpg\', \'\', \'2016-12-16 04:18:56\', \'\', \'\', \'0\', \'1\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'5\', \'4\', \'3\', \'2013-12-16\', \'1\', \'0\', \'25\', \'b-blog-3.jpg\', \'\', \'2013-12-19 01:21:28\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'6\', \'4\', \'4\', \'2013-12-18\', \'1\', \'0\', \'127\', \'b-blog-5.jpg\', \'\', \'2016-12-07 23:53:04\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'7\', \'4\', \'5\', \'2013-12-18\', \'1\', \'0\', \'81\', \'b-blog-8.jpg\', \'\', \'2016-12-07 23:53:39\', \'\', \'\', \'0\', \'1\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'8\', \'4\', \'1\', \'2013-12-18\', \'1\', \'0\', \'27\', \'b-blog-6.jpg\', \'\', \'2013-12-19 22:50:10\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'9\', \'4\', \'6\', \'2013-12-18\', \'1\', \'0\', \'19\', \'b-blog-7.jpg\', \'\', \'2013-12-18 03:32:42\', \'\', \'\', \'0\', \'1\', \'1\', \'\')'; 
 $query_sql['psblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'psblog_blog( `id_psblog_blog`,`id_psblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`thumb`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'10\', \'4\', \'7\', \'2016-12-07\', \'1\', \'0\', \'24\', \'b-blog-4.jpg\', \'\', \'2016-12-07 23:51:27\', \'\', \'\', \'0\', \'1\', \'1\', \'\')'; 
