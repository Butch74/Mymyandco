...
class PsWidgetBloglatest extends PsWidgetPageBuilder {
	...
	{
		return array('label' => 'Blog Latest', 'explain' => 'Integrate with Ps Blog Module to get blogs', 'group' => 'blog');
	}
	...
	public function renderContent($setting)
	{
		...
		if (file_exists(_PS_MODULE_DIR_.'psblog/classes/config.php'))
		{
			...
			$blogs = PsBlogBlog::getListBlogs(null, $this->lang_id, 0, $limit, 'date_add', 'DESC', array(), true);
