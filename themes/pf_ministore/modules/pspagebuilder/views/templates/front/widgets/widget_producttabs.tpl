...
<div class="widget-producttabs block block-highlighted {$addition_cls|escape:'html':'UTF-8'}">
	...
	<div class="widget-inner  pts-tab clearfix">
		...
		{foreach from=$producttabs item=ptab name=myproducttabs}
			...
			<li class="nav-item"><a data-toggle="tab" href="#tab-{$ptab.key|escape:'html':'UTF-8'}">{$ptab.title|escape:'html':'UTF-8'}</a></li>
			{/if}
		{/foreach}
		</ul>
