...
<div id="ptsblockblogstabs{$tabname|escape:'html':'UTF-8'}" class="widget-latestblog space-50 block {$addition_cls|escape:'html':'UTF-8'} {if isset($stylecls)&&$stylecls}block-{$stylecls|escape:'html':'UTF-8'}{/if}">
