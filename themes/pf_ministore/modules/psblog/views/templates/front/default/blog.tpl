			...
			<article class="blog-detail">
				...
				<div class="blog-meta">
					...
					<span class="blog-author">
						<span> {l s='Posted By' mod='psblog'}: </span>
				...
				{if $blog->preview_url && $config->get('item_show_image','1')}
					<div class="blog-image">
						<img src="{$blog->preview_url|escape:'html':'UTF-8'}" alt="{$blog->meta_title|escape:'html':'UTF-8'}" title="{$blog->meta_title|escape:'html':'UTF-8'}" class="img-fluid" />
					</div>
				{/if}
