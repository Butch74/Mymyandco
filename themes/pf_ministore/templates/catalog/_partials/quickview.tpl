      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 hidden-xs-down">
          ...
          <div class="arrows js-arrows">
            <i class="material-icons arrow-up js-arrow-up">keyboard_arrow_up</i>
            <i class="material-icons arrow-down js-arrow-down">keyboard_arrow_down</i>
          </div>
        </div>
        <div class="col-md-6 col-sm-6 pd-right">
          {block name='product_prices'}
            {include file='catalog/_partials/product-prices.tpl'}
          {/block}
          
          <h1 class="h1 product-name-detail">{$product.name}</h1>
