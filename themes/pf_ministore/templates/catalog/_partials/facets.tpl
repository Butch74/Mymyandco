 ...
 *}
  <div id="search_filters">
    ...
    <h4 class="title-sidebar hidden-sm-down">{l s='Filter By' d='Shop.Theme.Actions'}</h4>
    {/block}
	...
	{/block}
      {foreach from=$facets item="facet"}
        {if $facet.displayed}
          <section class="facet">
            <h4 class="h6 facet-title hidden-sm-down"><span>{$facet.label}</span></h4>
                        ...
                        {if $facet.multipleSelectionAllowed}
                          <span class="custom-checkbox">
                            ...
                            {if isset($filter.properties.color)}
                              ...
                              {else}
                              <span {if !$js_enabled} class="ps-shown-by-js" {/if}><i class="material-icons checkbox-checked">check</i></span>
                            {/if}
                          </span>
                        {else}
                          <span class="custom-checkbox">
