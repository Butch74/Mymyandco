...
class PsSliderLayerPreviewModuleFrontController extends ModuleFrontController
{
	...
	public function display()
	{
		...
		if (file_exists(_PS_THEME_DIR_.'assets/css/modules/pssliderlayer/css/typo.css'))
			$this->context->controller->addCSS(_PS_THEME_DIR_.'assets/css/modules/pssliderlayer/views/css/typo.css');
		else
